...
export const stakingProperties: PropertyDef[] = [
  {
    name: "invariant_reward_rate_consistency",
    description:
      "The reward rate must remain consistent with the configured emission schedule; no phantom rewards",
    severity: "critical",
  ...
  },
  {
    ...
    description:
      "Staking and then unstaking the same amount must return the original tokens with no loss or gain (excluding rewards)",
    severity: "critical",
  ...
  },
  {
    ...
    description:
      "Rewards must be distributed proportionally to each staker's share of the total staked amount",
    severity: "critical",
  ...
  },
  {
    ...
    description:
      "The total staked amount must equal the sum of all individual stake balances",
    severity: "critical",
  ...
  },
  {
    ...
    description:
      "An address with zero staked tokens must not earn any rewards",
    severity: "high",
  ...
  },
  {
    ...
    description:
      "The sum of all pending (claimable) rewards must not exceed the reward pool balance",
    severity: "critical",
  ...
  },
  {
    ...
    description:
      "An unstake operation must not withdraw more than the user's staked balance",
    severity: "high",
  ...
  },
  {
    ...
    description:
      "After claiming rewards, the user's earned amount must be zero (or accrue from the claim timestamp)",
    severity: "medium",
  ...
  },
  {
    ...
    description:
      "If the staking contract has a cooldown period, unstake must revert before cooldown elapses",
    severity: "high",
  ...
  },
  {
    ...
    description:
      "The cumulative rewardPerToken must be monotonically non-decreasing",
    severity: "high",
