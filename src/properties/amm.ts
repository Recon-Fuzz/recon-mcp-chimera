...
export const ammProperties: PropertyDef[] = [
  {
    name: "invariant_constant_product",
    description:
      "For constant-product AMMs: x * y must never decrease after a swap (k is non-decreasing due to fees)",
    severity: "critical",
  ...
  },
  {
    ...
    description:
      "LP shares must be proportional to the liquidity contributed relative to total pool liquidity",
    severity: "critical",
  ...
  },
  {
    ...
    description:
      "Collected fees must be fully accounted for: no fees can vanish or be double-counted",
    severity: "high",
  ...
  },
  {
    ...
    description:
      "No single swap or LP action should extract more value than deposited (arbitrage-free within the pool)",
    severity: "critical",
  ...
  },
  {
    ...
    description:
      "Tracked reserves must always match actual token balances held by the pool contract",
    severity: "critical",
  ...
  },
  {
    ...
    description:
      "The output amount of a swap must never exceed the reserve of the output token",
    severity: "high",
  ...
  },
  {
    ...
    description:
      "Adding liquidity must increase the invariant (k) or keep it the same",
    severity: "high",
  ...
  },
  {
    ...
    description:
      "Removing liquidity must return both tokens proportionally to the LP share burned",
    severity: "high",
  ...
  },
  {
    ...
    description:
      "Price impact of any single swap should be bounded by the swap amount relative to reserves",
    severity: "medium",
  ...
  },
  {
    ...
    description:
      "Swaps must revert when either reserve is zero",
    severity: "high",
