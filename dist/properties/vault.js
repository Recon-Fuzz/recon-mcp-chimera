export const vaultProperties = [
    {
        ...
        description: "The vault's underlying asset balance must always be >= the total shares redeemable value",
        severity: "critical",
    ...
    },
    {
        ...
        description: "The share price (assets per share) must never decrease outside of legitimate loss events",
        severity: "critical",
    ...
    },
    {
        ...
        description: "Depositing X assets and immediately withdrawing must return <= X assets (no profit from roundtrip)",
        severity: "critical",
    ...
    },
    {
        ...
        description: "Shares must never be minted without a corresponding deposit of underlying assets",
        severity: "critical",
    ...
    },
    {
        ...
        description: "After a withdrawal, total assets must decrease by at least the withdrawn amount",
        severity: "high",
    ...
    },
    {
        ...
        description: "maxWithdraw for any user must never exceed total assets in the vault",
        severity: "high",
    ...
    },
    {
        ...
        description: "previewDeposit and previewRedeem must match actual deposit/redeem results (within rounding)",
        severity: "medium",
    ...
    },
    {
        ...
        description: "Sum of all user share balances must equal totalSupply",
        severity: "high",
