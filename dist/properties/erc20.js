export const erc20Properties = [
    ...
    },
    {
        ...
        description: "A transfer must decrease sender balance and increase receiver balance by exactly the same amount",
        severity: "critical",
    ...
    },
    {
        ...
        description: "After a transferFrom, the allowance must decrease by the transferred amount (unless infinite)",
        severity: "high",
    ...
    },
    {
        ...
        description: "Transferring tokens to yourself must not change the total supply or your balance",
        severity: "medium",
    ...
    },
    {
        ...
        description: "Calling approve must not change any balance or the total supply",
        severity: "medium",
    ...
    },
    {
        ...
        description: "If minting is supported, total supply must increase by exactly the minted amount",
        severity: "high",
    ...
    },
    {
        ...
        description: "If burning is supported, total supply must decrease by exactly the burned amount",
        severity: "high",
