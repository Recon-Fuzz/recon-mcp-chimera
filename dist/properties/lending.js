export const lendingProperties = [
    {
        name: "invariant_collateral_ratio_above_minimum",
        description: "Every borrower's collateral ratio must remain above the minimum threshold at all times",
        severity: "critical",
    ...
    },
    {
        ...
        description: "Pool utilization rate must stay within [0, 1e18] (0% to 100%)",
        severity: "critical",
    ...
    },
    {
        ...
        description: "Interest rate must increase monotonically with utilization (no rate inversions)",
        severity: "high",
    ...
    },
    {
        ...
        description: "Liquidation must only succeed when health factor is below the liquidation threshold",
        severity: "critical",
    ...
    },
    {
        ...
        description: "Total borrows must never exceed total deposits in any market",
        severity: "critical",
    ...
    },
    {
        ...
        description: "Repaying a loan must reduce the borrower's debt by at least the repaid amount (minus interest accrued in same block)",
        severity: "high",
    ...
    },
    {
        ...
        description: "Borrow must revert if the user has no collateral deposited",
        severity: "high",
    ...
    },
    {
        ...
        description: "Accrued interest must always be non-negative (debt can only grow or be repaid)",
        severity: "high",
    ...
    },
    {
        ...
        description: "Protocol reserves must grow proportionally to interest collected",
        severity: "medium",
    ...
    },
    {
        ...
        description: "Flash loans must repay at least principal + fee; no tokens can be extracted for free",
        severity: "critical",
